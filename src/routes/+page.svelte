		...
		div.py50.s-px16
			...
			div.container-1024.text-left.mb20
				...
				p 約3年前、私は教員からプログラマーへ転職しました。当初はURLの意味も、API、DB（データベース）、サーバーの基本概念すらわからない状態でした。
					...
					br
					br
					|本サービスでは、Web開発に必要な知識を総合的に身に付けることを目標としてます。フロントとはバックエンドとはAPIとは、なぜサービスが動いているか。サービスの仕組みや必要な技術スタックを総合的に開発作業を通じて学び、なぜやどうしてを解決しプログラマーとしての基礎を築きます。基本を身につけ、自学で成長している段階を目指します。
